<?php
// source: C:\Users\usuario\Documents\GitHub\LandTravel_2\views\templates\usuarios\login.latte

use Latte\Runtime as LR;

class Templateed29acfde3 extends Latte\Runtime\Template
{
...
<form id="form-login" method="POST">
    <div class="card-body justify-content-center" style="min-width:16rem">
        ...
        <input class="form-control" id="correo" name="correo" type="email" placeholder="ejemplo@mail.com">
        <br>
        <label>Contraseña</label><br>
        <input class="form-control" id="contraseña" name="contraseña" type="password" placeholder="********">
        <a class="pb-3" href="/recuperar"><small>¿Olvidastes tu contraseña?</small></a>
        <div class="text-center">
