<?php
// source: C:\Users\usuario\Documents\GitHub\LandTravel_2\views\templates\components\viajes.latte

use Latte\Runtime as LR;

class Template7e203e3537 extends Latte\Runtime\Template
{
...
?>
                <div class="mb-3 btn-group" role="group">
                  ...
                  <a class="btn btn-primary disabled" href="<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($viaje['id'])) /* line 36 */ ?>/comprar" disabled>Comprar ahora</a>
                  <a class="btn btn-secondary disabled" href="<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($viaje['id'])) /* line 37 */ ?>/reservar" disabled>Reservar</a>
                </div>
<?php
				}
?>
